...
img_alt: Comparison of CFD and graph neural network flow predictions
github: https://github.com/FaiqShahbaz/CFD-GNN
importance: 1
category: research
...
{% include figure.liquid
   ...
   alt="CFD reference, GNN prediction, and absolute error for cavity velocity magnitude on a 21 by 21 grid"
...
{% include figure.liquid
   ...
   alt="CFD reference, GNN prediction, and absolute error for cavity velocity magnitude on a 41 by 41 grid"
   class="img-fluid rounded z-depth-1 my-3"
%}
...
{% include figure.liquid
   ...
   alt="CFD reference, GNN prediction, and absolute error for cavity velocity magnitude on a 61 by 61 grid"
   class="img-fluid rounded z-depth-1 my-3"
%}
...
{% include figure.liquid
   ...
   alt="Reference, GNN prediction, and absolute error for the potential field on a 10 by 5 grid"
   class="img-fluid rounded z-depth-1 my-3"
%}
...
{% include figure.liquid
   ...
   alt="Reference, GNN prediction, and absolute error for the potential field on a 20 by 10 grid"
   class="img-fluid rounded z-depth-1 my-3"
%}
...
{% include figure.liquid
   ...
   alt="Reference, GNN prediction, and absolute error for the potential field on a 30 by 15 grid"
   class="img-fluid rounded z-depth-1 my-3"
%}
